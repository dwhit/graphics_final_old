...
QT_MOC_LITERAL(6, 50, 5)
    ...
    "View\0_mouseDrag\0\0QMouseEvent*\0tick\0"
    "mouseDragEvent\0event\0"
};
...
void View::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->_mouseDrag((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        ...
        {
            typedef void (View::*_t)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&View::_mouseDrag)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void View::_mouseDrag(QMouseEvent * _t1)
{
